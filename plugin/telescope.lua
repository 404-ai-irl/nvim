...
local function ensure_plugin_built()
...
vim.keymap.set('n', '<leader>us', function() vim.opt.spell = not vim.opt.spell:get() end, { desc = 'Toggle Spelling' })
...
vim.keymap.set('n', '<leader>ul', function() vim.opt.number = not vim.opt.number:get() end, { desc = 'Toggle Line Numbers' })
vim.keymap.set('n', '<leader>ub', function() vim.opt.background = vim.opt.background:get() == 'dark' and 'light' or 'dark' end, { desc = 'Toggle Background' })
vim.keymap.set('n', '<leader>uh', function() vim.opt.hlsearch = not vim.opt.hlsearch:get() end, { desc = 'Toggle Search Highlights' })
